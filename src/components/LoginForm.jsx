...
function LoginForm() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="flex justify-center font-extrabold text-4xl font-serif mb-2">
        Login
      </h1>
      ...
      <div className="flex justify-center items-center">
        <button
          className="mt-4 w-72 flex justify-center items-center bg-gray-800 hover:bg-gray-900 text-white py-2 rounded focus:outline-none"
          type="button"
