...
function Navbar() {
  ...
  return (
    <div className="">
      <div className="w-full fixed flex dark:bg-main-dark-bg z-50">
        <div
        ...
        >
          <div className="flex items-center fixed md:static bg-main-bg navbar w-full text-left border-b border-gray-300 pt-5 pb-2 pl-3 bg-gradient-to-br bg-gradient-to-br from-indigo-100 to-indigo-400">
            {username ? (
              <img
