...
const ForkedRepos = () => {
  ...
  return (
    <div className="min-h-screen mt-12 ml-20 flex-col flex justify-center items-center p-4">
      <div
      ...
      >
        <div className="flex ml-5 h-fit text-4xl text-white font-serif p-4 justify-center rounded-lg shadow-lg  items-center border-black">
          <h1>Forked Repos</h1>
          <div className="ml-4">
