...
const TabletChartLayout = ({ username, currRepo }) => {
  ...
  return (
    ...
    <div className="w-screen h-full overflow-scroll p-20 pb-24 pt-24 pr-0">
      <div className="grid grid-cols-4 grid-rows-27 gap-4 pr-4 text-center ">
      ...
      <div
        className="col-span-4 row-span-3 col-start-1 row-start-10 ml-1 h-96 p-2 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <BarChart fullRepo={currRepo} />
      </div>
      <div
        className="flex row-span-2 col-start-1 row-start-14 rounded-xl shadow-3xl ml-1 h-64 items-center justify-center font-bold text-white bg-gradient-to-br from-yellow-300 to-orange-500 hover:from-pink-500 hover:to-yellow-500 z-10 transition ease-in-out duration-200 hover:w-80 hover:relative hover:right-24 oveflow-scroll"
        style={{
      ...
      <div
        className="col-span-3 col-start-2 row-start-14 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white bg-gradient-to-br from-emerald-500 to-emerald-800"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <Stargazers />
      </div>
      <div
        className="col-span-3 col-start-2 row-start-15 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white bg-gradient-to-br from-blue-500 to-blue-900"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <DateCreated />
      </div>
      <div
        className="col-span-4 row-span-3 col-start-1 row-start-16 p-2 h-96 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        Change Failure Rate (CFR)
      </div>
      <div
        className="col-span-4 row-span-6 col-start-1 row-start-20 p-2 h-192 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <Activity />
      </div>
      <div
        className="col-span-4 row-span-3 col-start-1 row-start-26 p-2 h-96 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <MergeSuccessRatePie />
      </div>
      <div
        className="col-start-2 row-start-30 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <NumCommits />
      </div>
      <div
        className="col-start-3 row-start-30 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <NumDeployments />
      </div>
      ...
      <div
        className="flex row-span-2 col-start-1 row-start-6 rounded-xl shadow-3xl ml-1 h-68 items-center justify-center font-bold text-white bg-gradient-to-br from-yellow-300 to-orange-500 hover:from-pink-500 hover:to-yellow-500 z-10 transition ease-in-out duration-200 hover:w-80 hover:relative hover:right-24 oveflow-scroll"
        style={{
          backgroundColor: "#171C2Eff",
          transition: "ease-in-out 500ms",
        }}
      ...
      <div
        className="col-span-4 row-span-3 col-start-1 row-start-8 ml-1 h-96 p-2 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <BarChart fullRepo={currRepo} />
      </div>
      ...
      <div
        className="col-start-6 row-start-2 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <NumCommits />
      </div>
      <div
        className="col-start-7 row-start-2 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <NumDeployments />
      </div>
      <div
        className="col-span-3 col-start-1 row-start-15 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white bg-gradient-to-br from-emerald-500 to-emerald-800"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <Stargazers />
      </div>
      <div
        className="col-span-3 col-start-1 row-start-14 p-2 h-32 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white bg-gradient-to-br from-blue-500 to-blue-900"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <DateCreated />
      </div>
      ...
      <div
        className="col-span-4 row-span-6 col-start-5 row-start-19 p-2 h-192 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <Activity />
      </div>
      <div
        className="col-span-4 row-span-3 col-start-1 row-start-25 p-2 h-96 text-center justify-center items-center font-bold rounded-xl shadow-3xl text-white"
        style={{ backgroundColor: "#171C2Eff" }}
      >
        <MergeSuccessRatePie />
      </div> */}
